...
import 'package:weather/app/modules/home/views/fore_ground_down_view.dart';
import 'package:weather/app/modules/home/views/fore_ground_up_view.dart';
...
class HomeView extends GetView<HomeController> {
  @override
  String ip_address = "https://www.google.com";

  void _get_livedata() async {
    Uri link = Uri.parse(ip_address);
    if (!await launchUrl(
      link,
      mode: LaunchMode.externalApplication
    )

    )throw 'Could not launch read data from $link';
    Get.back();
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            controller.components.menuItem(
                                ...
                                title: "Settings",
                                onClick: () =>
                                    controller.settingsOptionClicked(),
                                icon: Icons.settings),
                            SizedBox(
                              height: controller.size.height * 0.03,
                            ),
                                ...
                                child: !controller.loadingState
                                    ? Stack(
                                        ...
                                        children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: TextField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText: 'Enter Ip Adress for live data',
                                                    ),
                                                  ),
                                                )
                                                    ])),
                                          ...
                                          AnimatedOpacity(
                                              opacity: controller.isSettingsOpen
                                                  ? 1.0
                                                  : 0.0,
                                              duration:
